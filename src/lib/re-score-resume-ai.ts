...
const SYSTEM = `You are an ATS resume scoring engine. Be meticulous: small problems must surface in scores and issues.
...
- delta: your estimate of score change from previousScore if provided; otherwise estimate0 or a small change from a neutral baseline.
